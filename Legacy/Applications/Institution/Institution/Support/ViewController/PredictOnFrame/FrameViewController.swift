...
struct FrameViewControllerRepresentation: UIViewControllerRepresentable {
    typealias UIViewControllerType = FrameViewController
    
    func makeUIViewController(context: Context) -> FrameViewController {
        UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "FrameViewController") as! FrameViewController
    }
    
    func updateUIViewController(_ uiViewController: FrameViewController, context: Context) {
